...
const menuItems = [
  ...
  { title: "Manajemen Stok", href: "/admin/stok", icon: Package },
  { title: "Pusat Verifikasi", href: "/admin/verifikasi", icon: ClipboardCheck },
  { title: "Riwayat Audit", href: "/admin/riwayat", icon: ScrollText },
];
  ...
  return (
    <Sidebar collapsible="icon" className="border-r border-slate-200 bg-white">
      <SidebarHeader className="h-16 flex flex-row items-center border-b border-slate-100 p-0 group-data-[collapsible=icon]:justify-center">
        <Link href="/admin/dashboard" className="flex items-center gap-3 w-full px-6 group-data-[collapsible=icon]:px-0 group-data-[collapsible=icon]:justify-center overflow-hidden">
